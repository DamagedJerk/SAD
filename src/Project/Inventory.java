...
class Inventory extends RecursiveTreeObject<Inventory> {
    ...
    public Inventory(String id, String prodname, String quan, String price, String cat , String supp,String status,String cost) {
        ...
        this.product_cost=new SimpleStringProperty(cost);
